...
base_path_lin  = "/home/User/fyp/Malay/order_paper"
base_path_win = "C:/Users/User/Desktop/fyp/Malay/order_paper"

fn = os.path.join(base_path_lin, "parse/log.csv")
symbol_file = "/home/User/fyp/Malay/order_paper/lda/data/stopword.txt"
...
# pickle.dump(vocab, open('vocab.p', 'wb'), protocol=2)
# features.to_pickle('features.pd')
# data = dict(flattened=flattened, paper_id=paper_id_f, date_id=date_id_f)
# np.savez('data', **data)
# np.save(open('tokens.p', 'wb'), tokens)
# print "lda2vec complete"
pickle.dump(lda_tokens, open('tokens.p', 'wb'), protocol=2)
