...
base_path_lin  = "/home/User/fyp/Malay/hansard/process/lda2vec/measurement"
base_path_win = "C:/Users/User/Desktop/fyp/Malay/hansard/process/lda2vec/measurement"

topic_file = os.path.join(base_path_lin, "topic_30.csv")
coherence_file = os.path.join(base_path_lin, "coherence_30.csv")
